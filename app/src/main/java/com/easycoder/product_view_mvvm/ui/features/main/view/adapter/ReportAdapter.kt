...
import com.easycoder.product_view_mvvm.core.interfaces.SimplestCallback
...
RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.raw_view_items,parent,false)
    ...
    inner  class ReportViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView){
        ...
        fun container(report: Report){
            ...
            price.setText(report.price.toString() + " Tk" )
